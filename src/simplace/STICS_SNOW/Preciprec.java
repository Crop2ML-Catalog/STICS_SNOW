...
public class Preciprec extends FWSimComponent
{
    ...
    public HashMap<String, FWSimVariable<?>> createVariables()
    {
        ...
        addVariable(FWSimVariable.createSimVariable("spreciprec", "recalculated precipitation", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"http://www.wurvoc.org/vocabularies/om-1.8/", 0.0, 500.0, null, this));
