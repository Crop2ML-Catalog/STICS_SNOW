...
namespace Snow.Strategies
{
    public class SnowComponent : IStrategySnow
    {
        public SnowComponent()
        {
            ...
            pd2.PropertyType = (Snow.DomainClass.SnowAuxiliaryVarInfo.tmin).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(Snow.DomainClass.SnowAuxiliaryVarInfo.tmin);
            _inputs0_0.Add(pd2);
            ...
            pd4.DomainClassType = typeof(Snow.DomainClass.SnowAuxiliary);
            pd4.PropertyName = "precip";
            pd4.PropertyType = (Snow.DomainClass.SnowAuxiliaryVarInfo.precip).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(Snow.DomainClass.SnowAuxiliaryVarInfo.precip);
            _inputs0_0.Add(pd4);
            ...
            pd8.DomainClassType = typeof(Snow.DomainClass.SnowState);
            pd8.PropertyName = "ps";
            pd8.PropertyType = (Snow.DomainClass.SnowStateVarInfo.ps).ValueType.TypeForCurrentValue;
            pd8.PropertyVarInfo =(Snow.DomainClass.SnowStateVarInfo.ps);
            _inputs0_0.Add(pd8);
            mo0_0.Inputs=_inputs0_0;
            List<PropertyDescription> _outputs0_0 = new List<PropertyDescription>();
            PropertyDescription pd9 = new PropertyDescription();
            pd9.DomainClassType = typeof(Snow.DomainClass.SnowState);
            pd9.PropertyName = "tmaxrec";
            pd9.PropertyType = (Snow.DomainClass.SnowStateVarInfo.tmaxrec).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(Snow.DomainClass.SnowStateVarInfo.tmaxrec);
            _outputs0_0.Add(pd9);
            PropertyDescription pd10 = new PropertyDescription();
            pd10.DomainClassType = typeof(Snow.DomainClass.SnowState);
            pd10.PropertyName = "ps";
            pd10.PropertyType = (Snow.DomainClass.SnowStateVarInfo.ps).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(Snow.DomainClass.SnowStateVarInfo.ps);
            _outputs0_0.Add(pd10);
            PropertyDescription pd11 = new PropertyDescription();
            pd11.DomainClassType = typeof(Snow.DomainClass.SnowRate);
            pd11.PropertyName = "Mrf";
            pd11.PropertyType = (Snow.DomainClass.SnowRateVarInfo.Mrf).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(Snow.DomainClass.SnowRateVarInfo.Mrf);
            _outputs0_0.Add(pd11);
            PropertyDescription pd12 = new PropertyDescription();
            pd12.DomainClassType = typeof(Snow.DomainClass.SnowAuxiliary);
            pd12.PropertyName = "tavg";
            pd12.PropertyType = (Snow.DomainClass.SnowAuxiliaryVarInfo.tavg).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(Snow.DomainClass.SnowAuxiliaryVarInfo.tavg);
            _outputs0_0.Add(pd12);
            PropertyDescription pd13 = new PropertyDescription();
            pd13.DomainClassType = typeof(Snow.DomainClass.SnowState);
            pd13.PropertyName = "Swet";
            pd13.PropertyType = (Snow.DomainClass.SnowStateVarInfo.Swet).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(Snow.DomainClass.SnowStateVarInfo.Swet);
            _outputs0_0.Add(pd13);
            PropertyDescription pd14 = new PropertyDescription();
            pd14.DomainClassType = typeof(Snow.DomainClass.SnowState);
            pd14.PropertyName = "Snowmelt";
            pd14.PropertyType = (Snow.DomainClass.SnowStateVarInfo.Snowmelt).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(Snow.DomainClass.SnowStateVarInfo.Snowmelt);
            _outputs0_0.Add(pd14);
            PropertyDescription pd15 = new PropertyDescription();
            pd15.DomainClassType = typeof(Snow.DomainClass.SnowRate);
            pd15.PropertyName = "Snowaccu";
            pd15.PropertyType = (Snow.DomainClass.SnowRateVarInfo.Snowaccu).ValueType.TypeForCurrentValue;
            pd15.PropertyVarInfo =(Snow.DomainClass.SnowRateVarInfo.Snowaccu);
            _outputs0_0.Add(pd15);
            PropertyDescription pd16 = new PropertyDescription();
            pd16.DomainClassType = typeof(Snow.DomainClass.SnowState);
            pd16.PropertyName = "Sdry";
            pd16.PropertyType = (Snow.DomainClass.SnowStateVarInfo.Sdry).ValueType.TypeForCurrentValue;
            pd16.PropertyVarInfo =(Snow.DomainClass.SnowStateVarInfo.Sdry);
            _outputs0_0.Add(pd16);
            PropertyDescription pd17 = new PropertyDescription();
            pd17.DomainClassType = typeof(Snow.DomainClass.SnowState);
            pd17.PropertyName = "Sdepth";
            pd17.PropertyType = (Snow.DomainClass.SnowStateVarInfo.Sdepth).ValueType.TypeForCurrentValue;
            pd17.PropertyVarInfo =(Snow.DomainClass.SnowStateVarInfo.Sdepth);
            ...
            pd18.PropertyType = (Snow.DomainClass.SnowStateVarInfo.tminrec).ValueType.TypeForCurrentValue;
            pd18.PropertyVarInfo =(Snow.DomainClass.SnowStateVarInfo.tminrec);
            _outputs0_0.Add(pd18);
            PropertyDescription pd19 = new PropertyDescription();
            pd19.DomainClassType = typeof(Snow.DomainClass.SnowRate);
            pd19.PropertyName = "M";
            pd19.PropertyType = (Snow.DomainClass.SnowRateVarInfo.M).ValueType.TypeForCurrentValue;
            pd19.PropertyVarInfo =(Snow.DomainClass.SnowRateVarInfo.M);
            ...
            pd20.PropertyType = (Snow.DomainClass.SnowStateVarInfo.preciprec).ValueType.TypeForCurrentValue;
            pd20.PropertyVarInfo =(Snow.DomainClass.SnowStateVarInfo.preciprec);
        ...
        {
            get { return Snow.Strategies.SnowDepth.rhoVarInfo;} 
        }
        ...
        public string TestPostConditions(Snow.DomainClass.SnowState s,Snow.DomainClass.SnowState s1,Snow.DomainClass.SnowRate r,Snow.DomainClass.SnowAuxiliary a,Snow.DomainClass.SnowExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r21 = new RangeBasedCondition(Snow.DomainClass.SnowStateVarInfo.tmaxrec);
                if(r21.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowStateVarInfo.tmaxrec.ValueType)){prc.AddCondition(r21);}
                RangeBasedCondition r22 = new RangeBasedCondition(Snow.DomainClass.SnowStateVarInfo.ps);
                if(r22.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowStateVarInfo.ps.ValueType)){prc.AddCondition(r22);}
                RangeBasedCondition r23 = new RangeBasedCondition(Snow.DomainClass.SnowRateVarInfo.Mrf);
                if(r23.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowRateVarInfo.Mrf.ValueType)){prc.AddCondition(r23);}
                RangeBasedCondition r24 = new RangeBasedCondition(Snow.DomainClass.SnowAuxiliaryVarInfo.tavg);
                if(r24.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowAuxiliaryVarInfo.tavg.ValueType)){prc.AddCondition(r24);}
                RangeBasedCondition r25 = new RangeBasedCondition(Snow.DomainClass.SnowStateVarInfo.Swet);
                if(r25.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowStateVarInfo.Swet.ValueType)){prc.AddCondition(r25);}
                RangeBasedCondition r26 = new RangeBasedCondition(Snow.DomainClass.SnowStateVarInfo.Snowmelt);
                if(r26.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowStateVarInfo.Snowmelt.ValueType)){prc.AddCondition(r26);}
                RangeBasedCondition r27 = new RangeBasedCondition(Snow.DomainClass.SnowRateVarInfo.Snowaccu);
                if(r27.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowRateVarInfo.Snowaccu.ValueType)){prc.AddCondition(r27);}
                RangeBasedCondition r28 = new RangeBasedCondition(Snow.DomainClass.SnowStateVarInfo.Sdry);
                if(r28.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowStateVarInfo.Sdry.ValueType)){prc.AddCondition(r28);}
                RangeBasedCondition r29 = new RangeBasedCondition(Snow.DomainClass.SnowStateVarInfo.Sdepth);
                if(r29.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowStateVarInfo.Sdepth.ValueType)){prc.AddCondition(r29);}
                RangeBasedCondition r30 = new RangeBasedCondition(Snow.DomainClass.SnowStateVarInfo.tminrec);
                if(r30.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowStateVarInfo.tminrec.ValueType)){prc.AddCondition(r30);}
                RangeBasedCondition r31 = new RangeBasedCondition(Snow.DomainClass.SnowRateVarInfo.M);
                if(r31.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowRateVarInfo.M.ValueType)){prc.AddCondition(r31);}
                RangeBasedCondition r32 = new RangeBasedCondition(Snow.DomainClass.SnowStateVarInfo.preciprec);
                if(r32.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowStateVarInfo.preciprec.ValueType)){prc.AddCondition(r32);}
        ...
        public string TestPreConditions(Snow.DomainClass.SnowState s,Snow.DomainClass.SnowState s1,Snow.DomainClass.SnowRate r,Snow.DomainClass.SnowAuxiliary a,Snow.DomainClass.SnowExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r2 = new RangeBasedCondition(Snow.DomainClass.SnowAuxiliaryVarInfo.tmin);
                if(r2.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowAuxiliaryVarInfo.tmin.ValueType)){prc.AddCondition(r2);}
                ...
                RangeBasedCondition r4 = new RangeBasedCondition(Snow.DomainClass.SnowAuxiliaryVarInfo.precip);
                if(r4.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowAuxiliaryVarInfo.precip.ValueType)){prc.AddCondition(r4);}
                ...
                RangeBasedCondition r8 = new RangeBasedCondition(Snow.DomainClass.SnowStateVarInfo.ps);
                if(r8.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowStateVarInfo.ps.ValueType)){prc.AddCondition(r8);}
        ...
        public void Init(Snow.DomainClass.SnowState s,Snow.DomainClass.SnowState s1,Snow.DomainClass.SnowRate r,Snow.DomainClass.SnowAuxiliary a,Snow.DomainClass.SnowExogenous ex)
        {
