...
{
    public class SnowAccumulation : IStrategySnow
    {
        public SnowAccumulation()
        {
            ...
            pd1.PropertyType = (Snow.DomainClass.SnowAuxiliaryVarInfo.tmax).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(Snow.DomainClass.SnowAuxiliaryVarInfo.tmax);
            _inputs0_0.Add(pd1);
        ...
        public string TestPostConditions(Snow.DomainClass.SnowState s,Snow.DomainClass.SnowState s1,Snow.DomainClass.SnowRate r,Snow.DomainClass.SnowAuxiliary a,Snow.DomainClass.SnowExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r5 = new RangeBasedCondition(Snow.DomainClass.SnowRateVarInfo.Snowaccu);
                if(r5.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowRateVarInfo.Snowaccu.ValueType)){prc.AddCondition(r5);}
        ...
        public string TestPreConditions(Snow.DomainClass.SnowState s,Snow.DomainClass.SnowState s1,Snow.DomainClass.SnowRate r,Snow.DomainClass.SnowAuxiliary a,Snow.DomainClass.SnowExogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(Snow.DomainClass.SnowAuxiliaryVarInfo.tmax);
                if(r1.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowAuxiliaryVarInfo.tmax.ValueType)){prc.AddCondition(r1);}
