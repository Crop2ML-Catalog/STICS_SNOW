...
{
    public class Refreezing : IStrategySnow
    {
        public Refreezing()
        {
            ...
            pd1.PropertyType = (Snow.DomainClass.SnowAuxiliaryVarInfo.tavg).ValueType.TypeForCurrentValue;
            pd1.PropertyVarInfo =(Snow.DomainClass.SnowAuxiliaryVarInfo.tavg);
            _inputs0_0.Add(pd1);
            ...
            pd2.PropertyType = (Snow.DomainClass.SnowRateVarInfo.Mrf).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(Snow.DomainClass.SnowRateVarInfo.Mrf);
            _outputs0_0.Add(pd2);
        ...
        public string TestPreConditions(Snow.DomainClass.SnowState s,Snow.DomainClass.SnowState s1,Snow.DomainClass.SnowRate r,Snow.DomainClass.SnowAuxiliary a,Snow.DomainClass.SnowExogenous ex,string callID)
        {
            try
            {
                ...
                ConditionsCollection prc = new ConditionsCollection();
                Preconditions pre = new Preconditions(); 
                RangeBasedCondition r1 = new RangeBasedCondition(Snow.DomainClass.SnowAuxiliaryVarInfo.tavg);
                if(r1.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowAuxiliaryVarInfo.tavg.ValueType)){prc.AddCondition(r1);}
