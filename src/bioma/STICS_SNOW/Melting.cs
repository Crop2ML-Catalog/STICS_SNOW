...
{
    public class Melting : IStrategySnow
    {
        public Melting()
        {
            ...
            pd2.PropertyType = (Snow.DomainClass.SnowAuxiliaryVarInfo.tavg).ValueType.TypeForCurrentValue;
            pd2.PropertyVarInfo =(Snow.DomainClass.SnowAuxiliaryVarInfo.tavg);
            _inputs0_0.Add(pd2);
            ...
            pd3.PropertyName = "M";
            pd3.PropertyType = (Snow.DomainClass.SnowRateVarInfo.M).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(Snow.DomainClass.SnowRateVarInfo.M);
            _outputs0_0.Add(pd3);
        ...
        {
            get { return "It simulates snow in the process of melting" ;}
        }
        ...
        public string TestPostConditions(Snow.DomainClass.SnowState s,Snow.DomainClass.SnowState s1,Snow.DomainClass.SnowRate r,Snow.DomainClass.SnowAuxiliary a,Snow.DomainClass.SnowExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r6 = new RangeBasedCondition(Snow.DomainClass.SnowRateVarInfo.M);
                if(r6.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowRateVarInfo.M.ValueType)){prc.AddCondition(r6);}
        ...
        public string TestPreConditions(Snow.DomainClass.SnowState s,Snow.DomainClass.SnowState s1,Snow.DomainClass.SnowRate r,Snow.DomainClass.SnowAuxiliary a,Snow.DomainClass.SnowExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r2 = new RangeBasedCondition(Snow.DomainClass.SnowAuxiliaryVarInfo.tavg);
                if(r2.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowAuxiliaryVarInfo.tavg.ValueType)){prc.AddCondition(r2);}
