...
{
    public class TempMin : IStrategySnow
    {
        public TempMin()
        {
            ...
            pd3.PropertyType = (Snow.DomainClass.SnowStateVarInfo.tminrec).ValueType.TypeForCurrentValue;
            pd3.PropertyVarInfo =(Snow.DomainClass.SnowStateVarInfo.tminrec);
            _outputs0_0.Add(pd3);
        ...
        {
            get { return "recalculation of minimum temperature" ;}
        }
        ...
        public string TestPostConditions(Snow.DomainClass.SnowState s,Snow.DomainClass.SnowState s1,Snow.DomainClass.SnowRate r,Snow.DomainClass.SnowAuxiliary a,Snow.DomainClass.SnowExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r6 = new RangeBasedCondition(Snow.DomainClass.SnowStateVarInfo.tminrec);
                if(r6.ApplicableVarInfoValueTypes.Contains( Snow.DomainClass.SnowStateVarInfo.tminrec.ValueType)){prc.AddCondition(r6);}
